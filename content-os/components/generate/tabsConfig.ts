import { FileText, Sparkles, Layers, ImageIcon, RefreshCw, Wand2, LayoutGrid, Smartphone, Newspaper } from "lucide-react"

export type Tab = "ad_maker" | "full_post" | "carousel" | "stories" | "hooks" | "content" | "images" | "repurpose" | "blog"
