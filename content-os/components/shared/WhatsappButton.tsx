...
export function WhatsappButton() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 h-14 w-14">
      {/* Attention-pulse ring, sits behind the button and expands outward
          on a loop -- the button itself doesn't move, only this ring does. */}
      <span
        aria-hidden="true"
      ...
      <a
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-transform hover:scale-105"
        style={{ backgroundColor: "#25D366" }}
      >
