...
function selectTemplate(format: ContentFormat, platform: Platform, hookLen: number): 1 | 2 | 3 | 4 | 5 | 6 {
...
export function generatePostCardHtml(
  ...
  const templateNum = selectTemplate(format, platform, hookText.length)
