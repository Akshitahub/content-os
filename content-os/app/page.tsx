...
export default async function RootPage() {
  ...
  return (
    <>
      {/* ── CSS animations ─────────────────────────────────────────────── */}
      <style>{`
        /* Hero 3-frame crossfade (8 s cycle) */
        @keyframes heroFrame {
          0%, 25%   { opacity: 1; }
          33.33%, 100% { opacity: 0; }
        }
      ...
      <div className="min-h-screen bg-white text-gray-900">
        ...
        >
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:px-8">
            {/* Logo — dark version (shown on dark bg) */}
            <span className="nav-logo-dark flex items-center gap-2" style={{ display: "flex" }}>
              ...
              <span className="font-semibold tracking-tight text-white" style={{ fontSize: "0.95rem" }}>
                ContentOS
              </span>
            </span>
            {/* Logo — light version (shown on white bg) */}
            <span className="nav-logo-light items-center gap-2" style={{ display: "none" }}>
              ...
              <span className="font-semibold tracking-tight text-gray-900" style={{ fontSize: "0.95rem" }}>
                ContentOS
              </span>
            </span>
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <Link
                href={primaryHref}
                className="rounded-full bg-violet-600 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-violet-700 hover:scale-[1.02]"
              >
                {primaryLabel}
              </Link>
            </div>
        ...
        ════════════════════════════════════════════════════════ */}
        <section
          className="relative overflow-hidden px-6 pb-24 pt-32 sm:px-8 sm:pb-32 sm:pt-40"
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-6 max-w-lg text-lg leading-relaxed text-gray-400">
                  ContentOS learns your brand voice from your website and generates hooks,
                  captions, reels, carousels, ad copy, and email sequences — tailored to you,
                  not templates.
                </p>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  <Link
                    href={primaryHref}
                    className="inline-flex items-center gap-2 rounded-full bg-violet-600 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-violet-700 hover:scale-[1.02]"
                  >
              ...
              {/* Right — animated mockup (3 frames) */}
              <div
                className="relative mx-auto h-72 w-full max-w-md rounded-2xl border border-white/10 lg:h-80"
                style={{ backgroundColor: "#1a1a1a" }}
              >
                {/* Frame 1 — URL input */}
                <div
                  className="hero-frame-1 absolute inset-0 flex flex-col items-start justify-center rounded-2xl p-8"
                  style={{ opacity: 0 }}
                >
                  ...
                  <div className="flex w-full items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-3">
                    ...
                    <span className="text-sm text-white">
                      yourbrand.com
                      <span className="cursor ml-0.5 text-violet-400">|</span>
                    </span>
                  </div>
                  <button
                    className="mt-4 rounded-full bg-violet-600 px-5 py-2 text-xs font-semibold text-white"
                    aria-hidden="true"
                    tabIndex={-1}
                  >
                    Analyse my brand →
                ...
                {/* Frame 2 — Loading bar */}
                <div
                  className="hero-frame-2 absolute inset-0 flex flex-col items-start justify-center rounded-2xl p-8"
                  style={{ opacity: 0 }}
                >
                  <p className="mb-3 text-xs font-medium uppercase tracking-widest text-gray-500">
                    Step 2 — AI analysis
                  ...
                  <div className="mt-4 space-y-2">
                    {["Scraping website content", "Detecting tone & voice", "Building brand profile"].map(
                      (t) => (
                ...
                {/* Frame 3 — Content calendar grid */}
                <div
                  className="hero-frame-3 absolute inset-0 flex flex-col items-start justify-center rounded-2xl p-8"
                  style={{ opacity: 0 }}
                >
                  <p className="mb-3 text-xs font-medium uppercase tracking-widest text-gray-500">
                    Step 3 — 30 days ready
                  </p>
                  <div className="grid w-full grid-cols-6 gap-2">
                    {[
                      ...
                      <div
                        key={i}
                        className={`${color} flex h-14 items-center justify-center rounded-lg text-xs font-bold text-white opacity-90`}
                      >
                        {i + 1}
                      </div>
                    ))}
        ...
        <section id="how" className="bg-white px-6 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 text-center">
              <span className="mb-3 inline-block rounded-full bg-violet-50 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-violet-600">
                How it works
              </span>
              ...
              {[
                {
                  ...
                  desc: "Drop in your website or store URL. ContentOS reads your pages, products, and copy to understand your brand.",
                },
                {
                  Icon: Sparkles,
                  step: "02",
                  title: "AI learns your brand",
                  desc: "Our AI extracts your tone, audience, and positioning — building a brand profile unique to you.",
                },
                {
                  Icon: Zap,
                  step: "03",
                  title: "Generate everything",
                  desc: "Hooks, captions, reels, carousels, email sequences — 30 days of on-brand content in one click.",
                },
              ...
              {[
                {
                  ...
                  desc: "Scroll-stopping first lines tuned to your brand voice, with the reasoning behind each one.",
                  icon: "⚡",
                },
                {
                  title: "Reel Scripts",
                ...
                {
                  title: "Carousels",
                  desc: "Slide-by-slide content plans for educational and product carousels that actually get saved.",
                  icon: "🎠",
                },
                {
                  title: "Email Sequences",
                  desc: "Welcome, nurture, and launch sequences written in your brand's tone, not a generic template.",
                  icon: "📧",
                },
                {
                  title: "Influencer Outreach",
                  desc: "Personalized DM and email pitches for collaborations — tailored to each creator's niche.",
                  icon: "🤝",
                },
                {
                  title: "Fastlane",
                  desc: "Our flagship: paste your URL, get 30 days of planned, ready-to-post content instantly.",
                  icon: "🚀",
                  highlight: true,
                },
                ...
                >
                  ...
                  {highlight && (
                    <span className="mt-3 inline-block rounded-full bg-violet-600/20 px-2.5 py-0.5 text-xs font-semibold text-violet-300">
                      Flagship
                    </span>
                  )}
                </div>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div>
                ...
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                  30 days of content.{" "}
                  <span className="text-violet-600">One click.</span>
                </h2>
                <p className="mt-4 text-lg leading-relaxed text-gray-500">
                  Fastlane reads your entire brand, builds a content strategy, and generates a
                  full month of posts — hooks, captions, format types, and posting schedule
                  included. No prompting. No editing templates. Just done.
                </p>
                <Link
                  href={primaryHref}
                  className="mt-8 inline-flex items-center gap-2 rounded-full bg-violet-600 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-violet-700"
                >
              ...
              >
                ...
                <div className="mt-8 rounded-xl border border-white/5 bg-white/5 p-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-200">
                    &ldquo;The feeling of putting something handmade on and just knowing — this was made
                    for you. Shop our new collection → link in bio&rdquo;
                  </p>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              ...
              <div className="flex flex-col rounded-2xl border border-gray-200 p-8">
                ...
                <Link
                  href="/signup"
                  className="rounded-full border border-gray-200 px-5 py-2.5 text-center text-sm font-semibold text-gray-700 transition hover:bg-gray-50"
                >
                  Get started free
                </Link>
              </div>
              ...
              <div className="relative flex flex-col rounded-2xl border-2 border-violet-600 p-8 shadow-lg shadow-violet-100">
                ...
                <Link
                  href="/signup"
                  className="rounded-full bg-violet-600 px-5 py-2.5 text-center text-sm font-semibold text-white transition hover:bg-violet-700"
                >
                  Start Starter plan
                </Link>
              </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {[
                {
                  quote:
                    "I used to spend 2 hours on a Sunday planning content. Now I run Fastlane on Monday morning and I'm done in 4 minutes.",
                  name: "Priya M.",
                  role: "Founder, handmade jewellery brand",
                  initials: "PM",
                  color: "bg-violet-600",
                },
                {
                  quote:
                    "The hooks it generates actually sound like me. Not some American SaaS voice — my voice. That was the thing I was most afraid of with AI tools.",
                  name: "Rajan S.",
                ...
                {
                  quote:
                    "Switched from a freelancer to ContentOS. Same output quality, a fraction of the cost, and I can generate on-demand instead of waiting a week.",
                  name: "Anika T.",
                  role: "Home décor brand, Meesho",
                  initials: "AT",
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`${color} flex h-9 w-9 items-center justify-center rounded-full text-xs font-bold text-white`}
                    >
                      {initials}
                    </div>
                    <div>
        ...
        >
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-400">
              Your brand URL is all you need to get started.
            </p>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link
                href={primaryHref}
                className="inline-flex items-center gap-2 rounded-full bg-violet-600 px-8 py-4 text-base font-semibold text-white transition-all hover:bg-violet-700 hover:scale-[1.02]"
              >
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-10 sm:grid-cols-4">
              ...
              <div className="sm:col-span-1">
                ...
                <p className="mt-3 text-sm leading-relaxed text-gray-400">
                  The AI content operating system for ecommerce brands.
                </p>
              </div>
            ...
            <div className="mt-10 border-t pt-6" style={{ borderColor: "#1f1f1f" }}>
              <p className="text-xs text-gray-600">
                &copy; {new Date().getFullYear()} ContentOS. Built by Akshita Singh. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
